...
export default class RegistrationForm{
    ...
    events() {
        ...
        // to avoid quickly loses focus on field escape - like pressing tab after . super quick in password field
    ...
    passwordImmediately() {
        if (this.password.value.length > 50) {
            this.showValidationError(this.password, "Password cannot exceeds 50 characters")
