...
Follow.prototype.validate = async function(action) {
    ...
    if (action == "delete") {
        if (!doesFollowAlreadyExist) {this.errors.push("You cannot stop following someone you have not followed")}
    }
...
Follow.prototype.create = function() {
    return new Promise(async (resolve, reject) => {
        ...
        if (!this.errors.length) {
            console.log(`createing follow: authorId is ${this.authorId}`)
...
Follow.getFollowersById = function(id) {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            console.log('rejected in Follow -> getFollowersById')
            console.log(e)
            reject()
        }
    })
...
Follow.getFollowingById = function(id) {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            console.log('rejected in Follow -> getFollowingById')
            console.log(e)
            reject()
        }
    })
